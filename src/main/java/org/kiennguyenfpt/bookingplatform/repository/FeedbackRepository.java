...
import org.kiennguyenfpt.bookingplatform.dto.photographer.PhotographerAggregate;
import org.kiennguyenfpt.bookingplatform.entity.Feedback;
...
public interface FeedbackRepository extends JpaRepository<Feedback, BigInteger> {
    ...
    @Query("""
    SELECT new org.kiennguyenfpt.bookingplatform.dto.photographer.PhotographerAggregate(
        p.id,
        COUNT(DISTINCT b.id),
